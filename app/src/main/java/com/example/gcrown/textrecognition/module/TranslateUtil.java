...
public class TranslateUtil extends AppCompatActivity implements MainContract {
    ...
    class TranslateTask extends AsyncTask<Void, Void, String> {
        ...
        String content;
        Context context;
        MainContract.TranslateCallback callback;
        //private LoadingDalog loadingDalog = null; // 这个请自己定义加载中对话框，或者干脆不使用

        TranslateTask(Context context, String sourceLan, String targetLan, String content, MainContract.TranslateCallback callback) {
...
//            result = "翻译失败";
    ...
    /*public void translate(Context context, String targetLan, String content, MainContract.TranslateCallback callback) {
        translate(context, LAN_AUTO, targetLan, content, callback);
        Log.e("wasdwasd", "123456789");
